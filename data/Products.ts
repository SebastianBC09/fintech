...
export const products: Product[] = [
  {
    ...
    category: 'account',
    description:
      'La cuenta sin comisiones que te ofrece todos los servicios bancarios modernos con la conveniencia digital que necesitas.',
  ...
  },
  {
    ...
    category: 'account',
    description:
      'Disfruta de los beneficios exclusivos de nuestra cuenta premium con atención personalizado y beneficios únicos para clientes exigentes.',
    ...
    details: {
      minimumAmount: 50000,
      fees: [
        'Sin comisión por transferencias internacionales',
        'Sin comisión por retiros en cajeros globales',
      ],
      requirements: [
  ...
  },
  {
    ...
    category: 'card',
    description:
      'La tarjeta de crédito que recompensa cada compra con puntos y beneficios exclusivos en viajes y entretenimiento.',
  ...
  },
  {
    ...
    category: 'card',
    description:
      'La tarjeta de crédito premium con los mejores beneficios del mercado y servicio de concierge exclusivo.',
  ...
  },
  {
    ...
    category: 'investment',
    description:
      'Fondo de inversión balanceado con una estrategia de crecimiento moderado a mediano plazo.',
  ...
  },
  {
    ...
    category: 'investment',
    description:
      'Fondo de inversión en renta variable enfocado en crecimiento agresivo con horizonte a largo plazo.',
    ...
    details: {
      ...
      fees: [
        'Comisión por administración: 2.0% anual',
        'Comisión por rendimiento: 10% sobre excedente',
      ],
  ...
  },
  {
    ...
    category: 'investment',
    description:
      'Fondo de inversión enfocado en preservación de capital con rendimientos estables.',
  ...
  },
  {
    ...
    category: 'insurance',
    description:
      'Seguro de vida con cobertura integral que protege a tu familia y construye un patrimonio a largo plazo.',
  ...
  },
  {
    ...
    category: 'insurance',
    description:
      'El plan de seguro médico más completo con cobertura nacional e internacional y servicios exclusivos.',
  ...
  },
  {
    ...
    category: 'loan',
    description:
      'Préstamo personal con condiciones flexibles para cualquier proyecto o necesidad, con aprobación rápida.',
  ...
  },
  {
    ...
    category: 'loan',
    description:
      'Crédito hipotecario con proceso 100% digital, tasas competitivas y condiciones flexibles.',
    ...
    details: {
      ...
      requirements: [
        'Ingresos mínimos comprobables de $30,000',
